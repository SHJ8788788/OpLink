...
namespace UaOpcClient
{
    ...
    public class UaOpcHelper
    {
        ...
        {
            m_OpcStatusChange?.Invoke( this, new OpcStatusEventArgs( )
            {
                Error = error,
        ...
        /// </summary>
        public event EventHandler<OpcStatusEventArgs> OpcStatusChange
        {
        ...
        protected bool m_IsConnected;                       //是否已经连接过
        protected int m_reconnectPeriod = 10;               // 重连状态
        protected bool m_useSecurity;

        protected SessionReconnectHandler m_reconnectHandler;
        ...
        protected EventHandler<OpcStatusEventArgs> m_OpcStatusChange;
        protected bool reconnectEnable;
        protected int reconnectInterval;

        protected Dictionary<string, Subscription> dic_subscriptions;        // 系统所有的节点信息
        #endregion
